  ...
  const loaded = () => {
    return (
      <div className="outside-container">
        <div className="testimonial-show-container">
          <div>
            <Link to="/testimonials" className="return-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="100" fill="rgb(210, 210, 210)" className="bi bi-arrow-return-left" viewBox="0 0 16 16">
                <path fillRule="evenodd" d="M14.5 1.5a.5.5 0 0 1 .5.5v4.8a2.5 2.5 0 0 1-2.5 2.5H2.707l3.347 3.346a.5.5 0 0 1-.708.708l-4.2-4.2a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 8.3H12.5A1.5 1.5 0 0 0 14 6.8V2a.5.5 0 0 1 .5-.5z" /> </svg>
            </Link>
          </div>
          <div className="button-container">
              <button className="delete-button" onClick={deleteTestimonial} >
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="100" fill="rgb(210, 210, 210)" className="bi bi-trash" viewBox="0 0 16 16">
          ...
          <div className="show-container">
            ...
            <div className="show-data">
              <h1 className="display-4">{testimonial.title}</h1> <br />
              <p className="lead">{testimonial.opinion}</p> <br />
              </div>
              <p className="createdBy">Created By: {testimonial.createdBy}</p>
              <p className="location">Location: {testimonial.location}</p>
          </div>
        </div>
      </div>
    );
